        ...
        <form onSubmit={handleSubmit} className="form-body">
          ...
          <div className="input-group">
            ...
            <input type="text" name="fullName" value={formData.fullName}
              onChange={handleChange} placeholder={t('fullNamePH')} className="large-input" />
          </div>
          ...
          <div className="input-group">
            ...
            <input type="text" name="hospital" value={formData.hospital}
              onChange={handleChange} placeholder={t('hospitalNamePH')} className="large-input" />
          </div>

          <div className="input-group">
            <label>{t('area') || 'Area / District'}</label>
            <input type="text" name="area" value={formData.area}
              onChange={handleChange} placeholder="e.g. Vaishali Nagar" className="large-input" />
          </div>
